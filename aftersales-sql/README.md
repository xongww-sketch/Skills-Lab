...
| 时间戳转换 | 激活日期 → Asia/Shanghai 当天 00:00:00 的秒级 Unix 时间戳（无偏移） |
...
把激活日期当作 **Asia/Shanghai 当天 00:00:00**，转成**秒级 Unix 时间戳**，不加任何偏移。

```
activatetime = 该日期在 Asia/Shanghai 的 00:00:00 对应的 Unix 秒
```

验证基准：`2025-12-21` → `1766246400`
